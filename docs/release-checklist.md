...
HOME2-UI-POLISH 已按截图反馈精修首页首屏、主模块卡片、常见场景、规划中小工具、底部区域、历史页空状态和 about 页；以下仍需维护者在 DevTools / 真机本地勾选。

必测路径：

- 首页：三模块入口、历史、关于
  - 第一屏品牌区文案不重复，“开始问事 / 查看历史”入口可用
  - 三大主模块卡片层级清晰，卡片不拥挤，文字 / 标签 / 进入箭头在窄屏不重叠
  - 常见场景中感情关系观察低于三大主模块，事业选择 / 学习规划 / 人际沟通显示为 disabled 规划态且不跳转
  - 传统文化小工具规划区为两列均衡布局，梦境意象解析、姓名笔画观察、起名灵感助手、节气行动卡均不作为正式入口
