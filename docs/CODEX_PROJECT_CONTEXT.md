...
更新时间：2026-06-27
任务：BAZI1.4-DEPLOY-QA：backend-only 部署与八字 v2 报告线上验证
...
本次 BAZI1.4-DEPLOY-QA 开始时：

- 当前分支：`main`
- 当前 HEAD：`29beebf feat(bazi): improve v2 report quality`
...
- `scripts/check-api-smoke.sh`：13 PASS / 0 FAIL，奇门 v1 / poc / professional 均通过。
